...
Found a bug or have a suggestion? [Open an issue](https://github.com/eucann-dev/oscal-skills/issues) with:
...
1. **Fork and clone the repository**
   ```bash
   git clone https://github.com/eucann-dev/oscal-skills.git
   cd oscal-skills
   ```
...
- **Questions?** Open a [discussion](https://github.com/eucann-dev/oscal-skills/discussions)
- **Found a bug?** Open an [issue](https://github.com/eucann-dev/oscal-skills/issues)
